...
function initExtension() {
  ...
  if ($("video").length === 0) {
    ...
    if ($("#subtitle-button").length) {
      ...
      $('#info').find('#top-level-buttons').append('<div id="subtitle-button" class="subtitleButton" type="button" onclick=";return false;" data-button-toggle="true"><span class="subtitleButtonImg"><img src="'+ chrome.extension.getURL("images/icon2.jpg")+'" width="18px"></span><span class="subtitleButtonText">Videoken</span></div>');
